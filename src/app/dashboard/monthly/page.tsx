...
import { MonthlyReviewPanelNew } from "@/components/reviews/monthly-review-panel-new";
...
export default async function MonthlyReviewPage({
  ...
  const { activeSprint, monthlyLogs, promiseLogs, latestReview, monthStr, allReviews } = await getMonthlyData(params.month);
