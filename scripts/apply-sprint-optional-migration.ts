/**
 * Script to apply the sprint optional migration
 * Run with: npx tsx scripts/apply-sprint-optional-migration.ts
 */
...
async function applyMigration() {
    const migrationFile = path.join(process.cwd(), 'drizzle', '0013_lush_obadiah_stane.sql');
